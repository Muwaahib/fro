                    ...
                    <div class="w-full mx-auto text-gray-800 font-light mb-6 border-b border-gray-200 pb-6">
                        <div class="w-full flex items-center">
                            <div class="overflow-hidden rounded-lg w-16 h-16 bg-gray-50 border border-gray-200">
                              <img src="https://www.pngmart.com/files/8/Shirt-PNG-Transparent.png" className="" alt="" />
                            ...
                            <div class="flex-grow pl-3">
                                <h6 class="font-semibold uppercase text-gray-600">Shaadhadh.</h6>
                ...
                <div class="px-3 md:w-5/12">
                    ...
                    <div class="w-full mx-auto rounded-lg bg-white border border-gray-200 text-gray-800 font-light mb-6">
                        <div class="w-full p-3 border-b border-gray-200">
                          <div className="mb-5">
                            <label  for='type' className="flex items-center cursor-pointer">
                              ...
                              <img src="https://upload.wikimedia.org/wikipedia/commons/3/3e/Telesom_logo.png" alt="" className="h-6 ml-3" />
                              <img src="https://seeklogo.com/images/S/somtel-telecommunications-company-logo-48753CDA07-seeklogo.com.png"className="h-6 ml-3" alt="" />
                            </label>
