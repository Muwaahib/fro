  ...
  return (
   <div class="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <a href="#" class="flex items-center space-x-2 bg-purple-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded transition duration-150" title="Return Home">
           
            <Link to="/">Return Home</Link>
        </a>
    </div>
    <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4 color-blue">
        <img className='bg-blue' src="https://tailwindcomponents.com/svg/404-error-with-broken-robot-pana.svg" alt="" />
